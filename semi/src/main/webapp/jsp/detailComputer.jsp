...
<body>
	<div class="whole">
		...
		<%
		String pname = "LG 그램 16Z90P-GA7IK";

		ProductDAO dao = new ProductDAO();
		ComputerVO vo = dao.getComputerInfo(pname);
		%>
		<div id="container">
			...
			<div id="analysisdiv" class="wrapper">
				...
				<div class="analysis">
					<div>
						<%
						String src1 = null;
						if (vo.getPrice() <= 800000)
							src1 = "../images/공통_가격(저렴).png";
						else if (800000 < vo.getPrice() && vo.getPrice() <= 1500000)
							src1 = "../images/공통_가격(보통).png";
						else if (vo.getPrice() > 1500000)
					...
					<div class="analysis">
						...
						String src2 = null;
						if (vo.getWeight() <= 1.3)
							src2 = "../images/노트북_무게(가벼움).png";
						else if (1.3 < vo.getWeight() && vo.getWeight() <= 1.8)
							src2 = "../images/노트북_무게(보통).png";
						else if (vo.getWeight() > 1.8)
							src2 = "../images/노트북_무게(무거움).png";
						%>
							<img src="<%=src2%>" alt="" />
						</div>
					</div>
					...
					<div class="analysis">
						...
						String src3 = null;
						if (vo.getPsize() < 15.6)
							src3 = "../images/노트북_크기(작음).png";
						else if (15.6 <= vo.getPsize() && vo.getPsize() <= 17)
							src3 = "../images/노트북_크기(보통).png";
						else if (vo.getPsize() > 17)
							src3 = "../images/노트북_크기(큼).png";
						%>
							<img src="<%=src3%>" alt="" />
						</div>
					</div>
			...
			<div id="recomdivh">
				<span>이런 제품은 어떠신가요?</span><img src="../images/computer.png" alt="" />
			</div>
			<div id="recomdiv">
				<div>
					<img src="../images/computer1.jpg" alt="" class="recomimg" /><br />
					<span>한성컴퓨터 TFG276RT</span>
				</div>
				<div>
					<img src="../images/computer2.jpg" alt="" class="recomimg" /><br />
					<span>ASUS 비보북 X415MA</span>
				</div>
				<div>
					<img src="../images/computer4.jpg" alt="" class="recomimg" /><br />
					<span>LG 2021 울트라기어 17UD70P-PX76K WIN10 16GB램</span>
				</div>
				<div>
					<img src="../images/computer8.jpg" alt="" class="recomimg" /><br />
					<span>삼성전자 갤럭시북 프로 NT950XDB-KD71B</span>
				</div>
				<div>
					<img src="../images/computer10.jpg" alt="" class="recomimg" /><br />
					<span>삼성전자 노트북 Plus NT550XDZ-AD1AG 8GB램</span>
				</div>
			</div>
