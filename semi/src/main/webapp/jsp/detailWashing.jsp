...
<body>
	<div class="whole">
		...
		<%
		String pname = "LG 트롬 스팀 ThinQ F24KF";

		ProductDAO dao = new ProductDAO();
		WashingVO vo = dao.getWashingInfo(pname);
		%>
		<div id="container">
			...
			<div id="analysisdiv" class="wrapper">
				...
				<div class="analysis">
					<div>
						...
						else if (1000000 < vo.getPrice() && vo.getPrice() <= 1500000)
					...
					<div class="analysis">
						...
						String src2 = null;
						if (vo.getLiter() <= 10)
							src2 = "../images/세탁기_용량(작음).png";
						else if (10 < vo.getLiter() && vo.getLiter() <= 20)
							src2 = "../images/세탁기_용량(보통).png";
						else if (vo.getLiter() > 20)
							src2 = "../images/세탁기_용량(큼).png";
						%>
							<img src="<%=src2%>" alt="" />
						</div>
					</div>
					...
					<div class="analysis">
						...
						<%
						String src3 = null;
						if (vo.getPtype().equals("드럼"))
							src3 = "../images/세탁기_타입(드럼).png";
						else if (vo.getPtype().equals("통돌이"))
							src3 = "../images/세탁기_타입(통돌이).png";
						%>
							<img src="<%=src3%>" alt="" />
						</div>
					</div>
			...
			<div id="recomdivh">
				<span>이런 제품은 어떠신가요?</span><img src="../images/tv.png" alt="" />
			</div>
			<div id="recomdiv">
				<div>
					<img src="../images/washing1.jpg" alt="" class="recomimg" /><br />
					<span>LG 트롬 스팀 ThinQ F24WDLD</span>
				</div>
				<div>
					<img src="../images/washing2.jpg" alt="" class="recomimg" /><br />
					<span>LG 트롬 스팀펫 F24EDE</span>
				</div>
				<div>
					<img src="../images/washing3.jpg" alt="" class="recomimg" /><br />
					<span>LG 트롬 트윈워시 F24VDSDM</span>
				</div>
				<div>
					<img src="../images/washing4.jpg" alt="" class="recomimg" /><br />
					<span>LG 트롬 스팀펫 트윈워시 F24EDEM</span>
				</div>
				<div>
					<img src="../images/washing6.jpg" alt="" class="recomimg" /><br />
					<span>LG 트롬 플러스 F21VBT</span>
				</div>
			</div>
