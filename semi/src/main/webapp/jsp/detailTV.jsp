...
<body>
	<div class="whole">
		...
		<div id="container">
			...
			<div id="analysisdiv" class="wrapper">
				...
				<div class="analysis">
					<div>
						...
						else if (1000000 < vo.getPrice() && vo.getPrice() <= 2300000)
							src1 = "../images/공통_가격(보통).png";
						else if (vo.getPrice() > 2300000)
					...
					<div class="analysis">
						<div>
							...
							String src2 = null;
							if (vo.getPsize() <= 40)
								src2 = "../images/tv_크기(작음).png";
							else if (40 < vo.getPsize() && vo.getPsize() <= 65)
								src2 = "../images/tv_크기(보통).png";
							else if (vo.getPsize() > 65)
								src2 = "../images/tv_크기(큼).png";
							%>
							<img src="<%=src2%>" alt="" />
						</div>
					</div>
					...
					<div class="analysis">
						<div>
							<%
							String src3 = null;
							if (vo.getPixel().equals("1920X1080"))
								src3 = "../images/tv_해상도(보통).png";
							else if (vo.getPixel().equals("3820X2160") || vo.getPixel().equals("7680X4320"))
								src3 = "../images/tv_해상도(높음).png";
							else
								src3 = "../images/tv_해상도(낮음).png";
			...
			<div id="recomdiv">
				<div>
					<img src="../images/TV2.png" alt="" class="recomimg" /><br /> <span>삼성
						KQ43LST05A-MS</span>
				</div>
				<div>
					<img src="../images/TV5.png" alt="" class="recomimg" /><br /> <span>삼성
						KQ43LST01BF</span>
				</div>
				<div>
					<img src="../images/TV7.png" alt="" class="recomimg" /><br /> <span>LG
						75NANO93KPA</span>
				</div>
				<div>
					<img src="../images/TV10.png" alt="" class="recomimg" /><br /> <span>샤오미
						L55M5-5ASP</span>
				</div>
				<div>
					<img src="../images/TV6.png" alt="" class="recomimg" /><br /> <span>삼성
						UN65RU7400F</span>
				</div>
			</div>
